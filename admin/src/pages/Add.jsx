  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <textarea onChange={(e)=> setDescription(e.target.value)}  value={description} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='write your content here' required/>
      </div>

      <div className='flex flex-col sm:flex-row gap2 w-full sm:gap-8'>
        <div>
      ...
      <button type="submit" className='w-28 py-3 mt-4 bg-gray-600 text-white rounded-lg'>ADD</button>
